...
describe("CellularAutomaton class", () => {
  ...
  describe("constructor", () => {
    it("new CellularAutomaton() initializes as expected", () => {
      const grid: Grid = newZerosGrid(3, 3);
      const CA: CellularAutomaton = new CellularAutomaton(grid, transitionCenter);
  ...
  describe("step methods", () => {
    ...
    describe("previousStep()", () => {
      it("previousStep() changes nothing at step 0", () => {
        const grid: Grid = newZerosGrid(3, 3); // step 0
        const CA: CellularAutomaton = new CellularAutomaton(grid, transitionCenter);
      ...
      it("previousStep() moves back one step.", () => {
        ...
        const expectedHistory_1: Array<Grid> = [newZerosGrid(3, 3)];
        const expectedGrid_1: Grid = [
          [0, 0, 0],
          [0, 1, 0],
          [0, 0, 0]
        ];
    ...
    describe("nextStep()", () => {
      it("nextStep() moves forward one step, adds previous grid to history. " +
        ...
        const expectedGrid_1: Grid = [
          [0, 0, 0],
          [0, 1, 0], // 3x3 grid with 1 grain at center (1, 1)
          [0, 0, 0]
        ];
        const expectedHistory_1: Array<Grid> = [newZerosGrid(3, 3)];
        const expectedStep_1: number = 1;
        ...
        const expectedGrid_2: Grid = [
          [0, 0, 0],
          [0, 2, 0], // 3x3 grid with 1 grain at center (1, 1)
          [0, 0, 0]
        ];
        const expectedHistory_2: Array<Grid> = [newZerosGrid(3, 3), expectedGrid_1];
        const expectedStep_2: number = 2;
  ...
  describe("Cell state getters and setters", () => {
    it("getCellState() gets expected cell state", () => {
      const grid_1: Grid = newZerosGrid(3, 3);
      const grid_2: Grid = [
        [0, 0, 0],
        [0, 5, 0],
        [0, 0, 0]
      ];
      const CA_1: CellularAutomaton = new CellularAutomaton(grid_1, transitionCenter);
      const CA_2: CellularAutomaton = new CellularAutomaton(grid_2, transitionCenter);
    ...
    it("setCellState() sets cell to expected state", () => {
      ...
      const stateToSet: number = 5; // No reason for 5, can be arbitrary.
