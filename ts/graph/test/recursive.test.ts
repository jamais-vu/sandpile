...
describe("Recursive Sandpile, 2x2 grid", () => {
  ...
  describe("addGrain (recursive)", () => {
    let sandpile: LatticeGraph = new LatticeGraph(2, 2);
    let vertex_00: Vertex = sandpile.getVertex(0, 0) as Vertex; // We know it exists.
  ...
  describe("topple (recursive)", () => {
    let sandpile: LatticeGraph = new LatticeGraph(2, 2);
    let vertex_00: Vertex = sandpile.getVertex(0, 0) as Vertex;
    let vertex_01: Vertex = sandpile.getVertex(0, 1) as Vertex;
    let vertex_10: Vertex = sandpile.getVertex(1, 0) as Vertex;
    let vertex_11: Vertex = sandpile.getVertex(1, 1) as Vertex;
